...
class Tags extends CI_Controller {
	...
	function details($tag = FALSE)
	{
		...
		$tags_data = $this->instagram_api->get_tags($tag);
	...
	function recent($tag = FALSE)
	{
		...
		$data['tags_recent_data'] = $this->instagram_api->tags_recent($tag);
	...
	function search()
	{
		...
		$tags_search_data = $this->instagram_api->tags_search('skateboard', $this->session->userdata('instagram-token'));
