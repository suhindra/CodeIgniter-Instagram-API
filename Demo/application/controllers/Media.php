...
class Media extends CI_Controller {
	...
	function item($media_id = FALSE)
	{
		...
		$media_data = $this->instagram_api->get_media($media_id, $this->session->userdata('instagram-token'));
	...
	function popular() {
		...
		$data['popular_media_data'] = $this->instagram_api->popular_media();
	...
	function comments() {
		...
		$media_comments_data = $this->instagram_api->media_comments('3', $this->session->userdata('instagram-token'));
	...
	function likes() {
		...
		$media_likes_data = $this->instagram_api->media_likes('3', $this->session->userdata('instagram-token'));
